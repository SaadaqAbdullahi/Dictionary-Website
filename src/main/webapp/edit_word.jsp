...
<body style="background-color:#D3D3D3">
	...
	<div class="header">
	<center><h1>Edit Word</h1></center>
	</div>
	<% word word = (word)request.getAttribute("word"); %>
	<form action="update?id=<c:out value='${word.id}'/>" method="post">
	<div class="form-group">
	<label for="term">Word</label>
	<input type="text" name="term" class="form-control" id="term" value="<c:out value='${word.term}'/>"><br/>
	<%
	...
	<input type="text" name="definition" class="form-control" id="definition" value="<c:out value='${word.definition}'/>"><br/>
	<%
	...
	<input type="text" name="example" class="form-control" id="example" value="<c:out value='${word.example}'/>"><br/>
	<%
	...
	if( type == "updated"){%>
	<center><h2 style=color:green>Thank you.<br/> The word<i> <a href="search?term=<c:out value='${word.term}'/>"><c:out value="${word.term}"/></a></i> was updated to the dictionary!</h2></center>
	<%}%>
	</div>
</body>
</html>